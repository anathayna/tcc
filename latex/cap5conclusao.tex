...
Para contextualizar o desempenho do Experimento~3 em relação ao estado da arte, a Tabela~\ref{tab:comparacao-literatura} compara o AUROC do modelo proposto com resultados reportados na literatura.
